...
public class OfferServiceTestI2 {
    ...
    void assign_rejectsUEOverAssigned_err() {
        ...
        assertFalse(result.ok());
        assertEquals(Errors.ASSIGNMENT_ALREADY_EXISTS, result.message());
    }
    ...
    void getTotal_degree_ok() {
        ...
        offerService.createUE("Bd", 15, 10, 10, 0);
    ...
    void getTotalAllDegrees_ok() {
        ...
        offerService.createUE("Sys", 15, 10, 10, 10);
        offerService.selectYear(2);
        offerService.createUE("Net", 15, 10, 10, 10);
    ...
    void getCover_ue_ok() {
        ...
        offerService.createTeacher("Dupont", "Jean");
        offerService.assign("Algo", "Dupont", 15);
    ...
    void getCover_degree_ok_weighted() {
        ...
        offerService.createTeacher("Dupont", "Jean");
        offerService.assign("Algo", "Dupont", 15);
        offerService.assign("Bd", "Dupont", 5);
    ...
    void editUE_ok() {
        ...
        var result = offerService.editUE("Algo", 12, 8, 8, 8);
        assertTrue(result.ok());
    ...
    void editUE_rejectsOver30Hours() {
        ...
        var result = offerService.editUE("Algo", 12, 20, 10, 5);
        assertFalse(result.ok());
    ...
    void editUE_rejectsEctsOver60InYear() {
        ...
        offerService.createUE("UE2", 20, 10, 10, 10);

        var result = offerService.editUE("UE2", 30, 10, 10, 10);
        assertFalse(result.ok());
    ...
    void editUE_rejectsAssignedHoursGreaterThanNewTotal() {
        ...
        var result = offerService.editUE("Algo", 15, 5, 5, 5);
        assertFalse(result.ok());
